			...
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/showBookPage?category=${book.category }">&nbsp;${book.category}</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${book.name}
					</div>
									...
									<tr>
										<td width="30%">
											<div class="divbookcover">
												<p>
													<img src="<%=basePath %>${book.imgurl}" width="213" height="269" border="0" />
												</p>
											</div>

											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath }/addCart?id=${book.id}"> <img src="images/buybutton.gif" border="0" />
												</a>
											</div>
										</td>
