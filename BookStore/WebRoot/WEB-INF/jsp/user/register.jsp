					...
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput"
									name="email" /></td>
								<td><font color="#999999">请输入有效的邮箱地址</font><font color="red">${emailError }</font></td>
							</tr>
							<tr>
								...
								<td><font color="#999999">用户名设置至少4位</font><font color="red">${usernameError }</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="password" class="textinput"
									name="repassword" /></td>
								<td>&nbsp;<font color="red">${repasswordError }</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="textinput"
									style="width:350px" name="telephone" oninput = "value=value.replace(/[^\d]/g,'')" /></td>
							</tr>
							<tr>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width:50%"><input type="text" class="textinput" name="code"/><font color="red">${codeError}</font>
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
