			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/showCart">&nbsp;购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单
					</div>

					<form id="orderForm" action="${pageContext.request.contextPath }/submitOrder" method="post">
						<table cellspacing="0" class="infocontent">
							<tr>
								<td><table width="100%" border="0" cellspacing="0">
										<tr>
											<td><img src="images/buy2.gif" width="635" height="38" />
												<p>您好：${user.username }！欢迎您来到书城结算中心</p></td>
										</tr>
										<tr>
								...
								<c:forEach items="${cart }" var="p" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%"><fmt:formatNumber value="${p.key.price*p.value }" type="number" maxFractionDigits="2"/></td>
												...
												<table cellspacing="1" class="carttable">
													<tr>
														<td style="text-align:right; padding-right:40px;"><font
															style="color:#FF0000">合计：&nbsp;&nbsp;<fmt:formatNumber value="${count}" type="number" maxFractionDigits="2"/>元</font></td>
													</tr>
													<input type="hidden" name="money" value="<fmt:formatNumber value="${count}" type="number" maxFractionDigits="2"/>"/>
												</table>
