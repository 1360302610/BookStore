									...
									<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" class="textinput" value="${name }"/>
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		type="checkbox" name="remName" <c:if test="${name!=null && name!=''}">checked</c:if>/>
																...
																<tr>
																	<td colspan="2"
																		...
																		href="${pageContext.request.contextPath }/showRegisterUI"><img name="image"
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath }/showRegisterUI"><img
