...
<body style="text-align: center">
	<br/><br/>
	<form action="${pageContext.request.contextPath }/payOnline" method="post">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${orderid }" readonly="readonly"> 支付金额：<INPUT
			TYPE="text" NAME="money" value="0.01" readonly="readonly">元  ${money }
		<div class="divBank">
		<br/>
			<div class="divText">选择网上银行</div><br/>
			<div style="margin-left: 20px;">
				...
				<div style="margin-bottom: 20px;">
				    ...
				    <img name="BOC-NET-B2C" align="middle" src="${pageContext.request.contextPath}/bank_img/bc.bmp" />
				    <input id="PINGANBANK-NET" type="radio" name="yh" value="PINGANBANK-NET" />
					<img name="PINGANBANK-NET" align="middle" src="${pageContext.request.contextPath}/bank_img/pingan.bmp" />
					<input id="POST-NET-B2C" type="radio" name="yh" value="POST-NET-B2C" /> 
					<img name="POST-NET-B2C" align="middle" src="${pageContext.request.contextPath}/bank_img/post.bmp" />
