			...
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/showUserModifyUI?id=${user.id}">用户信息修改</a>
							</td>
						</tr>
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:void(0)" onclick="logout()">用戶退出</a></td>
						</tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/showMyAccountUI">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单查询
					</div>
					...
					<table cellspacing="0" class="infocontent">
						...
						<c:forEach items="${orders }" var="order" varStatus="vs">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath }/showOrderInfo?orderid=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="#">刪除</a>
										</td>
									</tr>
						</c:forEach>		
